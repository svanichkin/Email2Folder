...
require github.com/emersion/go-message v0.17.0
...
require (
	...
	github.com/emersion/go-imap/v2 v2.0.0-alpha.7 // indirect
	...
	github.com/wxdao/go-imap v0.0.0-20171102101307-a24865f13935
